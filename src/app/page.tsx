...
export default function Home() {
  return (
    <Tabs defaultValue="home" className="w-full h-full flex flex-col-reverse lg:flex-row">
		...
		<TabsContent value="home" className="overflow-auto p-2">
			<Dashboard />
		</TabsContent>
		<TabsContent value="planning" className="overflow-auto p-2">
			<Dashboard />
		</TabsContent>
		<TabsContent value="savings" className="overflow-auto p-2">
			<Dashboard />
		</TabsContent>
		<TabsContent value="profile" className="overflow-auto p-2">
			<Dashboard />
		</TabsContent>
	</Tabs>
  );
